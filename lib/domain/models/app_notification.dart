...
sealed class AppNotification with _$AppNotification {
  const factory AppNotification({String? msg, required NotificationType type, String? payload}) = _AppNotification;

  factory AppNotification.openFile(String path, NotificationType type) => AppNotification(type: type, payload: path);

  factory AppNotification.openTransaction(int id) =>
      AppNotification(type: NotificationType.openTransactionDetails, payload: '$id');
